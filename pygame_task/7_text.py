...
enemy_x_pos = screen_width / 2 - enemy_width / 2 # 화면 가로의 절반 크기에 해당하는 곳에 가로 위치
enemy_y_pos = screen_height / 2 - enemy_height / 2 # 화면 세로 크기 가장 아래에 해당하는 곳에 세로 위치
...
# 시간 계산
start_ticks = pygame.time.get_ticks() # 시작 tick을 받아옴ㅁ
